...
class Logger {
    ...
    async main(options) {
        ...
        if (options.logger.logLevel)
            this.setloglevel(options.logger.logLevel);
    ...
    async configureSentryScope() {
        this.sentry.configureScope(scope => {
            ...
            scope.clear();
            if ((_c = (_b = (_a = this.constructData) === null || _a === void 0 ? void 0 : _a.sentry) === null || _b === void 0 ? void 0 : _b.extras) === null || _c === void 0 ? void 0 : _c.user)
                scope.setUser((_e = (_d = this.constructData) === null || _d === void 0 ? void 0 : _d.sentry) === null || _e === void 0 ? void 0 : _e.extras.user);
            if ((_h = (_g = (_f = this.constructData) === null || _f === void 0 ? void 0 : _f.sentry) === null || _g === void 0 ? void 0 : _g.extras) === null || _h === void 0 ? void 0 : _h.tags)
                scope.setTags((_k = (_j = this.constructData) === null || _j === void 0 ? void 0 : _j.sentry) === null || _k === void 0 ? void 0 : _k.extras.tags);
            if ((_o = (_m = (_l = this.constructData) === null || _l === void 0 ? void 0 : _l.sentry) === null || _m === void 0 ? void 0 : _m.extras) === null || _o === void 0 ? void 0 : _o.context)
                (_q = (_p = this.constructData) === null || _p === void 0 ? void 0 : _p.sentry) === null || _q === void 0 ? void 0 : _q.extras.context.forEach(context => {
    ...
    async configureFile(fileData) {
        ...
        fs.access(fileData.config.logDirectory, fs.constants.F_OK, (err) => {
            if (!err) {
                ...
                fs.mkdir(fileData.config.logDirectory, { recursive: false }, async (err2) => {
                    if (err2)
                        this.constructorLogs.push({
                            data: {
                                name: '200',
    ...
    async log(loggingData) {
        ...
        loggingData.name = await this.translate(`videndum:logging.${loggingData.name}`);
        if (loggingData.name)
            loggingData.name = loggingData.name.toUpperCase();
    ...
    async loggcp(loggingData) {
        var _a, _b;
        // log to cloud logger
        if ((_b = (_a = this.constructData) === null || _a === void 0 ? void 0 : _a.gcp) === null || _b === void 0 ? void 0 : _b.enabled) {
            try {
                if (!this.gcpLogger)
                    return {
                        logged: false
    ...
    async logfile(loggingData, type) {
        ...
        if (type >= this.loglevel || process.env.DEBUG == 'true') {
            // Log to local logger
            if ((_b = (_a = this.constructData) === null || _a === void 0 ? void 0 : _a.file) === null || _b === void 0 ? void 0 : _b.enabled) {
                try {
    ...
    async logsentry(loggingData, type) {
        var _a, _b;
        // Log to sentry
        if (type > 4 && ((_b = (_a = this.constructData) === null || _a === void 0 ? void 0 : _a.sentry) === null || _b === void 0 ? void 0 : _b.enabled)) {
            try {
                ...
                this.sentry.configureScope(scope => {
                    ...
                    scope.setContext('device', {
                        Platform: (_c = loggingData.userData) === null || _c === void 0 ? void 0 : _c.platform,
                        Arch: (_d = loggingData.userData) === null || _d === void 0 ? void 0 : _d.arch,
                        Release: (_e = loggingData.userData) === null || _e === void 0 ? void 0 : _e.release
                    });
                    scope.setTag('Platform', (_f = loggingData.userData) === null || _f === void 0 ? void 0 : _f.platform);
                    scope.setTag('Arch', (_g = loggingData.userData) === null || _g === void 0 ? void 0 : _g.arch);
                    if (loggingData.tags)
                        scope.setTags(loggingData.tags);
                    if (loggingData.context)
                        loggingData.context.forEach(context => scope.setContext(context.name, context.data));
                    if (type == 5)
                ...
                this.log(new _1.LoggingDataClass(_1.LoggingLevels.error, 'Failed to log to sentry', {
                    errors: _
                }));
    ...
    async logconsole(loggingData, type) {
        var _a, _b;
        if ((_b = (_a = this.constructData) === null || _a === void 0 ? void 0 : _a.console) === null || _b === void 0 ? void 0 : _b.enabled) {
