...
import { ConstructData, fileDataType, GCPData, LoggingDataClass, LoggingLevels, LogReturn, LogReturned, SentryDataType } from '.';
...
declare type logTypes = 'DEFAULT' | 'DEBUG' | 'INFO' | 'NOTICE' | 'WARN' | 'ERROR' | 'CRITICAL' | 'ALERT' | 'EMERGENCY';
/**
