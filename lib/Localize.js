...
class Localizer {
    constructor() {
        ...
        this.t = (input, options) => {
            return this.localize.t([input, 'videndum:errors.unspecific.localize'], Object.assign(Object.assign({}, options), { replace: Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.replace), { what: input }) }));
        };
    ...
    async main(construct) {
        const resources = await this.createResources(construct === null || construct === void 0 ? void 0 : construct.localesLocation);
        this.localize.use(intervalPlural).init({
            lng: 'en',
            resources: resources,
            defaultNS: construct === null || construct === void 0 ? void 0 : construct.defaultNamespace,
            fallbackLng: {
                'de-CH': ['fr', 'it'],
                'zh-Hant': ['zh-Hans', 'en'],
                es: ['fr'],
    ...
    async createResources(construct) {
        ...
        for (let namespace in construct) {
            ...
            files.forEach(file => {
                ...
                if (!resource[file]) {
                    resource[file] = {};
                    resource[file][namespace] = require(path_1.default.join(location + file));
                }
                else if (!resource[file][namespace]) {
                    resource[file][namespace] = require(path_1.default.join(location + file));
                }
                else {
                    resource[file][namespace].concat(require(path_1.default.join(location + file)));
                }
            });
        }
        return resource;
